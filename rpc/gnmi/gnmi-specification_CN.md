...
# 内容列表
   ...
   * [1 介绍](#1-introduction)
   * [2 一般消息类型及编码，Common Message Types and Encodings](#2-common-message-types-and-encodings)
  * [2.1 可重用通知消息格式Reusable Notification Message Format](#21-reusable-notification-message-format)
  * [2.2 一般数据类型，Common Data Types](#22-common-data-types)
     * [2.2.1 时间戳，Timestamps](#221-timestamps)
     * [2.2.2 路径，Paths](#222-paths)
     * [2.2.3 节点值，Node Values](#223-node-values)
  * [2.3 结构化数据类型，Structured data types](#23-structured-data-types)
     * [2.3.1 JSON及JSON_IETF,JSON and JSON_IETF](#231-json-and-json_ietf)
     * [2.3.2 字节，Bytes](#232-bytes)
     * [2.3.3 Protobuf](#233-protobuf)
     * [2.3.4 文本，Text](#234-text)
  * [2.4 数据模式路径的使用，Use of Data Schema Paths](#24-use-of-data-schema-paths)
     * [2.4.1 路径前缀，Path Prefixes](#241-path-prefixes)
     * [2.4.2 路径别名，Path Aliases](#242-path-aliases)
     * [2.4.3 RPCs中使用的路径解读，Interpretation of Paths Used in RPCs](#243-interpretation-of-paths-used-in-rpcs)
  * [2.5 错误处理，Error handling](#25-error-handling)
  * [2.6 架构定义模型，Schema Definition Models](#26-schema-definition-models)
     * [2.6.1 ModelData消息，The ModelData message](#261-the-modeldata-message)
  * [2.7 gNMI扩展，Extensions to gNMI](#27-gnmi-extensions)
  * [3 服务定义，Service Definition](#3-service-definition)
  * [3.1 会话安全、身份验证和 RPC 授权，Session Security, Authentication and RPC Authorization](#31-session-security-authentication-and-rpc-authorization)
  * [3.2 能力发现，Capability Discovery](#32-capability-discovery)
     * [3.2.1 CapabilityRequest消息，The CapabilityRequest message](#321-the-capabilityrequest-message)
     * [3.2.2 CapabilityResponse消息，The CapabilityResponse message](#322-the-capabilityresponse-message)
  * [3.3 检索状态信息的快照，Retrieving Snapshots of State Information](#33-retrieving-snapshots-of-state-information)
     * [3.3.1 GetRequest消息，The GetRequest Message](#331-the-getrequest-message)
     * [3.3.2 GetResponse消息，The GetResponse message](#332-the-getresponse-message)
     * [3.3.3 使用获取的注意事项，Considerations for using Get](#333-considerations-for-using-get)
  * [3.4 状态修改，Modifying State](#34-modifying-state)
     * [3.4.1 SetRequest消息，The SetRequest Message](#341-the-setrequest-message)
     * [3.4.2 SetResponse消息，The SetResponse Message](#342-the-setresponse-message)
     * [3.4.3 事务，Transactions](#343-transactions)
     * [3.4.4 更新模式：替换与更新，Modes of Update: Replace versus Update](#344-modes-of-update-replace-versus-update)
  ...
  * [3.5 订阅上报数据更新，Subscribing to Telemetry Updates](#35-subscribing-to-telemetry-updates)   telemetry: 遥测，本文译为上报数据或数据上报
     * [3.5.1 管理订阅,Managing Subscriptions](#351-managing-subscriptions)
        ...
        * [3.5.1.3 Subscription消息，The Subscription Message](#3513-the-subscription-message)
        * [3.5.1.4 SubscribeResponse消息，The SubscribeResponse Message](#3514-the-subscriberesponse-message)
        * [3.5.1.5 创建订阅，Creating Subscriptions](#3515-creating-subscriptions)
           * [3.5.1.5.1 ONCE订阅，ONCE Subscriptions](#35151-once-subscriptions)
